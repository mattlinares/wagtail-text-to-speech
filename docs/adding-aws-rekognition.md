...
Add `...[rekognition]` when you install wagtail_text_to_speech (this will install the extra packages required).

- `pip install wagtail_text_to_speech[rekognition]`
...
- `ALT_GENERATOR_PROVIDER`: `'wagtail_text_to_speech.providers.rekognition.Rekognition'`
