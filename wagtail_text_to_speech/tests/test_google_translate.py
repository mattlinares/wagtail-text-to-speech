...
from wagtail_text_to_speech.translation_providers import get_provider, get_current_provider
...
class GoogleTranslateTest(TestCase):
    ...
    def test_that_get_provider_works(self):
        provider_cls = get_provider(
            "wagtail_text_to_speech.translation_providers.google_translate.GoogleTranslate"
        )
