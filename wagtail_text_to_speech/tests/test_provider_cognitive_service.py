...
from wagtail_text_to_speech.providers.cognitive import describe_by_url, describe_by_data
from wagtail_text_to_speech.utils import get_image_data
...
class ProviderCognitiveServiceTest(TestCase):
    ...
    def test_provider_describe_by_url(self):
        ...
        provider = get_provider("wagtail_text_to_speech.providers.cognitive.Cognitive")
