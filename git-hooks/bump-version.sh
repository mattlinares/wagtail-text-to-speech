...
# Bump django version
sed -i.bak 's/^__version__.=.*/__version__ = '\'''$VERSION''\''/' $ROOTDIR/wagtail_text_to_speech/__init__.py
rm wagtail_text_to_speech/__init__.py.bak

# Bump django build
sed -i.bak 's/^__build__.=.*/__build__ = '$VERSION_BUILD'/' $ROOTDIR/wagtail_text_to_speech/__init__.py
rm wagtail_text_to_speech/__init__.py.bak
